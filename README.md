...
### Contas criadas/garantidas no bootstrap
- **Admin**
  - Email: `dev.glxpartners@gmail.com`
  - Senha: `Dev.glxpartners!311`
- **Cliente de teste**
  - Email: `cliente.teste@glxpartners.com`
  - Senha: `Cliente123!`
- **Cliente de teste alternativo**
  - Email: `teste@glx.com`
  - Senha: `Cliente123!`

> Importante: altere credenciais padrao antes de qualquer uso em producao.
...
PORT=3000
JWT_SECRET=glx-dev-secret-key-change-in-production
DATABASE_URL=mysql://usuario:senha@localhost:3306/glx
```
...
Teste com as contas de bootstrap acima e confirme se o backend esta rodando.
