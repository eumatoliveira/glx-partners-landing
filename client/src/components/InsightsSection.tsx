    ...
    <section id="insights" className="relative overflow-hidden py-24 bg-[#040507]">
      ...
      <div className="container relative z-10 space-y-10">
        <div className="max-w-3xl">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-orange-500/25 bg-orange-500/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-orange-300">
